...
.txt_source<-function(file, fmt.locale=NULL, fmt.date=NULL, fmt.number=NULL, fmt.ignoreNumberGrouping=T, 
                      gathering.period=0, gathering.aggregation=c("None", "Sum", "Average", "First", "Last", "Max", "Min"), gathering.partialAggregation=F, gathering.includeMissing=F,
                      charset=NULL, delimiter=c('TAB', 'SEMICOLON', 'COMMA', 'SPACE'), textQualifier=c('NONE', 'QUOTE', 'DOUBLE_QUOTE'), headers=T, skipLines=0){
...
.r2jd_txt_id<-function(id){
  jsrc<-.txt_source(file=id$file, fmt.locale = id$format$locale, fmt.date = id$format$datePattern,
...
txt_content<-function(file, fmt.locale=NULL, fmt.date=NULL, fmt.number=NULL, fmt.ignoreNumberGrouping=T, 
                      gathering.period=0, gathering.aggregation=c("None", "Sum", "Average", "First", "Last", "Max", "Min"), gathering.partialAggregation=F, gathering.includeMissing=T,
                      charset=NULL, delimiter=c('TAB', 'SEMICOLON', 'COMMA', 'SPACE'), txtQualifier=c('NONE', 'QUOTE', 'DOUBLE_QUOTE'), header=T, skip=0){
  jsource<-.txt_source(file, fmt.locale, fmt.date, fmt.number, fmt.ignoreNumberGrouping, 
...
txt_data<-function(file, fmt.locale=NULL, fmt.date=NULL, fmt.number=NULL, fmt.ignoreNumberGrouping=T, 
                   gathering.period=0, gathering.aggregation=c("None", "Sum", "Average", "First", "Last", "Max", "Min"), gathering.partialAggregation=F, gathering.includeMissing=T,
                   charset=NULL, delimiter=c('TAB', 'SEMICOLON', 'COMMA', 'SPACE'), txtQualifier=c('NONE', 'QUOTE', 'DOUBLE_QUOTE'), header=T, skip=0){
  jsource<-.txt_source(file, fmt.locale, fmt.date, fmt.number, fmt.ignoreNumberGrouping, 
                       gathering.period, gathering.aggregation, gathering.partialAggregation, gathering.includeMissing,
...
txt_series<-function(file, series, fmt.locale=NULL, fmt.date=NULL, fmt.number=NULL, fmt.ignoreNumberGrouping=T, 
                     gathering.period=0, gathering.aggregation=c("None", "Sum", "Average", "First", "Last", "Max", "Min"), gathering.partialAggregation=F, gathering.includeMissing=T,
                     charset=NULL, delimiter=c('TAB', 'SEMICOLON', 'COMMA', 'SPACE'), txtQualifier=c('NONE', 'QUOTE', 'DOUBLE_QUOTE'), header=T, skip=0){
  jsource<-.txt_source(file, fmt.locale, fmt.date, fmt.number, fmt.ignoreNumberGrouping, 
                       gathering.period, gathering.aggregation, gathering.partialAggregation, gathering.includeMissing,
